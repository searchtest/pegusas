    ...
    <el-row class="panel">
      ...
      <el-col :span="8" style="padding-left: 10px; padding-right: 10px;">
        <el-form-item label="模板名称" prop="name">
          <el-input v-model="flume.name"></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="8" style="padding-left: 10px; padding-right: 10px;">
        <el-form-item label="模板描述" prop="description">
          <el-input v-model="flume.description"></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="8" style="padding-left: 10px; padding-right: 10px;">
        <el-form-item label="应用组" prop="team_id">
          <el-input v-model="flume.team_id"></el-input>
        </el-form-item>
      </el-col>
    </el-row>
    <el-row class="panel">
      ...
      <el-col :span="8" style="padding-left: 10px; padding-right: 10px;">
        <el-form-item label="日志全路径" >
          <el-input v-model="collect.flume_log_dir"></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="8" style="padding-left: 10px; padding-right: 10px;">
        <el-form-item label="功能描述">
          <el-input v-model="collect.flume_description"></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="8" style="padding-left: 10px; padding-right: 10px;">
        <el-form-item label="展示平台" >
          <el-input v-model="collect.flume_platform"></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="8" style="padding-left: 10px; padding-right: 10px;">
        <el-form-item label="目的kafka" >
          <el-input v-model="collect.flume_kafka"></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="8" style="padding-left: 10px; padding-right: 10px;">
        <el-form-item label="目的kafka topic">
          <el-input v-model="collect.flume_kafka_topic"></el-input>
        </el-form-item>
      </el-col>
