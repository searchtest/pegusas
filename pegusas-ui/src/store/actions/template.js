...
export const template_actions = {
  ...
  fetchTemplateDetail ({commit, state}, templateId) {
    ...
    axios.get('/api/v1/tempaltes/' + templateId + '/').then((res) => {
  ...
  updateTemplate ({commit, state}, params) {
    ...
    axios.put('/api/v1/tempaltes/' + params.id + '/', params).then((res) => {
  ...
  createTemplate ({commit, state}, params) {
    ...
    axios.post('/api/v1/tempaltes/', params).then((res) => {
